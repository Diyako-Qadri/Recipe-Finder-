      ...
      <div className="flex items-center">
        {user ? (
          <div className="p-5 flex flex-col gap-4 max-w-[1280px] m-auto w-full items-center md:items-start">
            ...
            <div className="grid relative m-auto w-full grow s:grid-cols-2 lg:grid-cols-3 justify-items-center  p-8 gap-16 sm:p-10 font-[family-name:var(--font-geist-sans)] max-w-[1280px]">
              {savedRecipe ? (
